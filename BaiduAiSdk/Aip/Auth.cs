...
namespace Baidu.Aip
{
    public class Auth
    {
        ...
        public static JObject OpenApiFetchToken(string ak, string sk, bool throws = false, bool debugLog = false)
        {
            ...
            try
            {
                webReq.ServerCertificateValidationCallback = new System.Net.Security.RemoteCertificateValidationCallback(xx);
        ...
        private static bool xx(object sender, X509Certificate certificate, X509Chain chain, SslPolicyErrors sslPolicyErrors)
        {
            return true;
        }
