...
//	        }
        ...
        protected HttpWebResponse SendRequetRaw(AipHttpRequest aipRequest)
        {
            ...
            webReq.ServerCertificateValidationCallback = xx;
        ...
        private bool xx(object sender, X509Certificate certificate, X509Chain chain, SslPolicyErrors sslPolicyErrors)
        {
            return true;
        }
